...
@Agent(
    description = "Given an article, extract the nodes and relationships from that article and persist them to a knowledge graph.",
)
@Profile("!test")
class KnowledgeGraphExtractorAgent(private val knowledgeGraphService: KnowledgeGraphService) {
    ...
    fun extractNodes(article: ArticleNode, context: OperationContext): ExtractedNodes {
        ...
        4. Do not explain your reasoning and try to Respond immediately with structured data only
